                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center p-8 rounded-top">
                                        ...
                                        <div class="symbol symbol-md bg-light-primary mr-3 flex-shrink-0">
                                            <img src="storage/assets/profil/{{ Auth::user()->img_profil }}" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                            ...
                            <ul class="menu-nav ">
                                <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="click"
                                    aria-haspopup="true"><a href="javascript:;" class="menu-link menu-toggle"><span
                                            class="menu-text">Dashboard</span><i class="menu-arrow"></i></a>
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            <li class="menu-item " aria-haspopup="true"><a href="home"
                                                    class="menu-link "><span class="menu-text">Podruits</span><span
                    ...
                    <div class="subheader py-2 py-lg-4 " id="kt_subheader">
                        <div class=" w-100  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Button-->
                                <a href="add_produit"
                                    class="btn btn-light-primary font-weight-bold btn-sm px-5 font-size-base ml-2">
