                        ...
                        <div class="card-body p-0">
                            <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-10">
                                    <!--begin::Wizard Form-->
                                    <form class="form" method="POST" action="save_produit" enctype="multipart/form-data">
                                        @csrf
                                                ...
                                                <div class="my-5 step" data-wizard-type="step-content"
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                class="form-control form-control-solid form-control-lg is-invalid"
                                                                name="description" type="text" value="" required>
                                                            <div class="fv-plugins-message-container">
                                                                <div data-field="lastname" data-validator="notEmpty"
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group input-group-solid input-group-lg">
                                                                <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-euro-sign"></i></span></div>
                                                                    <input type="number" class="form-control form-control-lg form-control-solid"  name="prix" required >
