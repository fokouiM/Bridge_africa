                                ...
                                <!--begin::Message In-->
                                    <span v-if="message.name_voyant == Active && message.name_voyant != null">
                                            <div class="d-flex flex-column mb-1 " :class="message.id_send == contact.id ? 'align-items-start' : 'align-items-end ' ">
                                                <div class="mt-2 rounded p-2 text-dark-50 font-weight-bold font-size-lg text-right new-style" :class="message.id_send == contact.id ? 'bg-light-primary text-right ' : ' bg-light-success text-left' " >
                                                    {{message.message}}
