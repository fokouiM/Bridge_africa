        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                ...
                <div class="card-toolbar">
                    ...
                    <!--begin::Button-->
                    <a href="#" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i> Ajouter un voyants </a>
                    <!--end::Button-->
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable_2">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> <a href="#"><i class="flaticon2-rubbish-bin"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#"><i class="flaticon2-edit"></i></a> </td>
                        </tr>
                    </tbody>
