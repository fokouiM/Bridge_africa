                        ...
                        <div class="card-body p-0">
                            <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-10">
                                    <!--begin::Wizard Form-->
                                    <form class="form" method="POST" action="save_users" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row justify-content-center">
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5 step" data-wizard-type="step-content"
                                                    ...
                                                    <h5 class="text-dark font-weight-bold mb-10"> Detail de l'utilisateur:
                                                    </h5>
                                                    <!--begin::Group-->
                                                    <div class="form-group ">
                                                        <label class="col-xl-3 col-lg-3 col-form-label"> nom ou adress mail</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <div class="fv-plugins-message-container">
                                                                <div data-field="firstname" data-validator="notEmpty"
                                                                    class="fv-help-block"> nom ou adress mail est obligatoire </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end::Group-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <div class="fv-plugins-message-container">
                                                                <div data-field="lastname" data-validator="notEmpty"
                                                                    class="fv-help-block">Le mot de passe est obligatoire</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--end::Group-->
