        ...
        <div class="main d-flex flex-column flex-row-fluid">
            ...
            <div class="content flex-column-fluid" id="kt_content">
                ...
                <div class="d-flex flex-row">
                            ...
                            <div class="card-header align-items-center px-4 py-3">
                                ...
                                <div class="text-right flex-grow-1">
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-md" style="width: 500px;">
                                            <!--begin::Navigation-->
                                            {{-- <ul class="navi navi-hover py-5" >
                                                <div class="d-flex flex-column mb-5 align-items-end" style="padding: 10px">
                                                    <div
                                                        class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-450px">
                                                ...
                                                <div class="card-footer align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mt-5">
                                                        ...
                                                        <div>
                                                            <button type="button"
                                                                class="btn btn-primary btn-md text-uppercase font-weight-bold chat-send py-2 px-6">Enregister</button>
                                                        </div>
                                                    </div>
                                                    <!--begin::Compose-->
                                                </div>
                    ...
                    <!--end::Content-->
                    <div class="flex-row-auto offcanvas-mobile w-200px w-xl-250px" id="kt_chat_aside" style="margin-left: 10px;">
                        <!--begin::Card-->
                        <div class="card card-custom">
                            <!--begin::Body-->
                            <div class="card-body">
                                ...
                                <div class="mt-7 scroll scroll-pull ps ps--active-y" style="height: 413px; overflow: hidden;">
                                    ...
                                    <div class="card-footer align-items-center" style="position: absolute; bottom: 0;">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-5">
                                            ...
                                            <div>
                                                <button type="button"
                                                    class="btn btn-primary btn-md text-uppercase font-weight-bold chat-send py-2 px-6">Enregistrer</button>
                                            </div>
                                        </div>
                                        <!--begin::Compose-->
                                    </div>
