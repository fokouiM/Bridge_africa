...
<div class="content flex-column-fluid" id="kt_content" style=" width: 100%;">
    @if (isset($GET['v2']))
        ...
        <div class="alert alert-custom alert-success fade show" role="alert">
            ...
            <div class="alert-text">{{$GET['v2']}}</div>
                    ...
                    <div class="scroll scroll-pull ps ps--active-y" data-mobile-height="350"
                        ...
                        <div class="messages">
                            ...
                            <div class="d-flex flex-column mb-5 align-items-start">
                                <div
                                    class="mt-2 rounded p-5 font-weight-bold  text-left max-w-800px " style="background-color: #014be369; color: #3a3a3a;">
