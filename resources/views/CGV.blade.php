...
<div class="card card-custom position-relative overflow-hidden">
    ...
    <div class="row" style="    width: 80%; margin-left: auto; margin-right: auto;">
        <div class="col-md-12 border-top pt-14 pb-10 pb-md-18" >
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-column">
                    <div class="font-weight-bold font-size-h6 mb-3"> <h4>ARTICLE 1. ACCEPTATION D’UNE COMMANDE A NOS SERVICES</h4></div>
    ...
    <div class="row" style="    width: 80%; margin-left: auto; margin-right: auto;">
        <div class="col-md-12 border-top pt-14 pb-10 pb-md-18" >
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-column">
                    <div class="font-weight-bold font-size-h6 mb-3"> <h4>ARTICLE 2. DESCRIPTION DU SERVICE ET DU PRIX</h4></div>
    ...
    <div class="row" style="    width: 80%; margin-left: auto; margin-right: auto;">
        <div class="col-md-12 border-top pt-14 pb-10 pb-md-18" >
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-column">
                    <div class="font-weight-bold font-size-h6 mb-3"> <h4>ARTICLE 3. PAIEMENT, SÉCURITÉ DES TRANSACTIONS ET PRÉLÈVEMENT</h4></div>
        ...
        <div class="col-md-12 border-top pt-14 pb-10 pb-md-18" >
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-between font-size-lg">
                        <span class="font-weight-bold mr-15">En cas d’annulation des Services, le montant déjà encaissé reste acquis et ne pourra pas faire l’objet d’un avoir.<br>
